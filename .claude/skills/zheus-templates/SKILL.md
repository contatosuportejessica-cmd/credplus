...
description: Catálogo de templates do Zheus — buscar, escolher, aplicar ou trocar template/tema do projeto. Use quando o usuário pedir um template/tema, quando o projeto não tem tema e merece um visual pronto, ou para listar os templates disponíveis.
---
